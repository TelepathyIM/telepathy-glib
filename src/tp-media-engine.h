...
void _tp_media_engine_register (TpMediaEngine *self);
void _tp_media_engine_stop_stream (TpMediaEngine *self);
void _tp_media_engine_signal_stream_error (TpMediaEngine *self, int error, const char *debug);
