      ...
      char **argv)
{
   ...
   * destroyed */
  b_stub = tp_tests_object_new_static_class (stub_object_get_type (), NULL);
  ...
  i_stub = tp_tests_object_new_static_class (stub_object_get_type (), NULL);
  ...
  j_stub = tp_tests_object_new_static_class (stub_object_get_type (), NULL);
  ...
  k_stub = tp_tests_object_new_static_class (stub_object_get_type (), NULL);
